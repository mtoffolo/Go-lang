...
func (repositorio Usuarios) Seguir(usuarioID, seguidorID uint64) error {
	...
	statement, erro := repositorio.db.Prepare("INSERT INTO public.seguidores (usuario_id, seguidor_id) VALUES($1, $2) on conflict (usuario_id,seguidor_id) do update set usuario_id = EXCLUDED.usuario_id,seguidor_id = EXCLUDED.seguidor_id;")
